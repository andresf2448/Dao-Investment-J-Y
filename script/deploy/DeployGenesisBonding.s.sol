...
contract DeployGenesisBonding is Script {
    address public genesisBondingAddress;

    function run(address _governanceToken, address _treasury, address _deployer, address[] memory _allowedTokens) external {
        ...
        genesisBondingAddress = address(genesisBonding);
