...
contract DeployProtocolCore is Script {
    address public protocolCoreAddress;

    function run(address _timeLock, address _deployer, address[] memory _allowedTokens) external {
        ...
        protocolCoreAddress = address(proxy);
